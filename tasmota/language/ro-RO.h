/*
  ...
  MERCHANTTY or FITNESS FOR A PARTICULAR PURPOSE.  See the
...
#define D_QUERY_DONE "Căutare terminat. Servicii MQTT găsite"
...
#define D_MQTT_FULL_TOPIC "Subiect Întreag MQTT"
